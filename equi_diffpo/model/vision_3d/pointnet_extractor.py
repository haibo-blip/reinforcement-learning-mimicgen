...
import equi_diffpo.model.vision_3d.point_process as point_process
...
if __name__ == "__main__":
    ...
    pointcloud_encoder_cfg.in_channels = 3
    pointcloud_encoder_cfg.out_channels = 256
    ...
    encoder = DP3Encoder(observation_space, state_mlp_size=state_mlp_size, state_mlp_activation_fn=state_mlp_activation_fn,
                         pointcloud_encoder_cfg=pointcloud_encoder_cfg, use_pc_color=False, 
                        #  pointnet_type='pointnet',
    ...
    observations = {
        ...
        'imagin_robot': torch.randn(2, 1024, 3)
    }
